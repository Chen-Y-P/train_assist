            ...
            table.on('tool(demo)', function(obj){ 
              ...
              if(obj.event === 'get'){
            	  $.ajax({
                      ...
                      //列尾作业接收时分 （反馈类型）
                      data:{"id":data.id,"jobStatus": 0,"ttStartTime": new Date().format("yyyy-MM-dd hh:mm:ss"), 
                	...
                	$.ajax({
                        ...
                        url:"${pageContext.request.contextPath }/scheduleJob/updateStatus",
                       //列尾作业完成时分 （反馈类型）
                        data:{"id":data.id,"jobStatus": 1,"ttFinishTime": new Date().format("yyyy-MM-dd hh:mm:ss"), 
