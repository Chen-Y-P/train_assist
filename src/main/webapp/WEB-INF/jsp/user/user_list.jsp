    ...
    <div class="x-body">
      ...
      <div class="layui-row" align="center">
	      <div class="layui-form-item">
		    ...
		    <div class="layui-inline">
          		<input type="text" id="aliases" name="aliases"  placeholder="用户别名" autocomplete="off" class="layui-input">
		    </div>
		    <div class="layui-inline">
          ...
          //执行一个 table 实例
            var tableIns = table.render({
              ...
              ,cols: [[ //表头
                ...
                ,{field: 'aliases', title: '用户别名', width:200}
